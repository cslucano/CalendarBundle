var sg_calendar_datepicker = (function() {
    ...
    return {
        ...
        initDatePicker : function() {
            ...
            if($.datepicker.regional[this.getLocale(4)] != undefined) {
                $.datepicker.setDefaults( $.datepicker.regional[this.getLocale(4)] );
            } else if($.datepicker.regional[this.getLocale(2)] != undefined) {
                $.datepicker.setDefaults( $.datepicker.regional[this.getLocale(2) ] );
            } else {
                $.datepicker.setDefaults( $.datepicker.regional['']);
            }

            $('.SgCalendarDatePicker').each(function() {
